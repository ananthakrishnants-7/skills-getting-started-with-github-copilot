...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer training and interscholastic matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice, fitness drills, and swim meet preparation",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, scene study, and theater production practice",
